        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Lower your monthly payment or get cash from your home
            </p>
              ...
              {[
                {
                  ...
                  description: 'Take advantage of low interest rates',
                },
                {
                  icon: Clock,
                  title: 'Quick closing',
                  description: 'Close in as little as 21 days',
                },
                {
                  icon: Shield,
                  title: 'Safe and secure',
                  description: 'Fully digital mortgage process',
                },
              ].map((feature, index) => (
                <div
                  key={index}
